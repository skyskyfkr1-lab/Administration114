...
export const SERVICES: ServiceItem[] = [
  {
    id: "suspension",
    title: "영업정지/과징금부과",
    description: "행정청의 위법·부당한 영업정지 처분 및 과도한 과징금에 대해 절차적 하자 및 재량권 남용 여부를 치밀하게 분석하여 사장님의 생존권을 지켜드립니다.",
    icon: <ShieldAlert className="w-8 h-8" />
  },
  {
    id: "police",
    title: "특별사법경찰/조사대응",
    description: "영장 없는 강제 수사나 고압적인 조사 환경에 적극 대응합니다. 수사 초기 진술 설계부터 변호사 동석까지, 형사처벌 위험을 원천 차단합니다.",
    icon: <UserCheck className="w-8 h-8" />
  },
  {
    id: "subsidy",
    title: "보조금/부정수급 방어",
    description: "보조금 환수 처분 및 제재 부가금 부과 통지에 대해 '고의성 없음'과 '단순 착오'를 법률적으로 입증하여 재산상 손실을 최소화합니다.",
  ...
  },
  {
    id: "planning",
    title: "도시계획/특수 기획",
    description: "도시계획 변경, 환매권 행사, 용도지역 변경 등 고도의 행정 실무 경험이 필요한 특수 프로젝트를 원스톱으로 수행합니다.",
    icon: <TrendingUp className="w-8 h-8" />
  },
  {
    id: "land",
    title: "토지보상/재산권보호",
    description: "토지수용 보상금 증액, 국공유지 무상 양도, 하천 미불용지 보상 등 행정법적 전문성이 필요한 모든 재산권 분쟁을 명쾌하게 해결합니다.",
