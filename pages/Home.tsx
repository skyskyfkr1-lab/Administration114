...
const Home: React.FC = () => {
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center bg-gradient-to-br from-[#F4F7FA] to-white py-12 md:py-32 overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            <h1 className="text-3xl md:text-7xl font-black text-[#002C5F] leading-tight mb-4 md:mb-8 break-keep">
              절망에서 <span className="text-[#F5A623]">확신으로</span>
            </h1>
            <p className="text-base md:text-2xl text-gray-700 font-bold mb-3 md:mb-4 break-keep leading-relaxed tracking-tight px-2">
              <span className="text-[#F5A623]">'진실 규명'과 '법의 허점 파악'</span>을 통해<br className="md:hidden" /> 역전가능성을 증명합니다.
            </p>
            <p className="text-xs md:text-xl text-gray-500 font-medium break-keep leading-relaxed mb-8 md:mb-10 opacity-90 max-w-2xl px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full sm:w-auto justify-center px-4">
              <Link to="/philosophy" className="bg-[#002C5F] text-white px-6 md:px-8 py-4 md:py-5 rounded-2xl font-bold text-base md:text-lg flex items-center justify-center hover:bg-[#001a3a] transition-all shadow-lg active:scale-95">
                투 트랙 솔루션 확인 <ChevronRight className="ml-1 w-5 h-5" />
              </Link>
              <Link to="/contact" className="bg-[#F5A623] text-white px-6 md:px-8 py-4 md:py-5 rounded-2xl font-bold text-base md:text-lg text-center hover:bg-[#e09512] transition-all shadow-lg active:scale-95">
                전략 상담 시작
              </Link>
            </div>
          </div>
