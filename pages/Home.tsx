    ...
    <div className="overflow-hidden">
      ...
      <section className="relative h-[80vh] flex items-center">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-[#0F4C81]/70" />
        </div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-block bg-[#F5A623] text-white px-4 py-1 rounded-full text-sm font-bold mb-6">
              소상공인·자영업자 행정 구제 전문
            </span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/contact" className="bg-[#F5A623] text-white px-8 py-4 rounded-lg font-bold text-lg flex items-center justify-center hover:bg-[#e09512] transition-all">
                무료 초기 진단 받기 <ChevronRight className="ml-2" />
              </Link>
              <Link to="/services" className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-8 py-4 rounded-lg font-bold text-lg text-center hover:bg-white/20 transition-all">
                해결 가능 업무 확인
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="mt-10 text-gray-500">
                행정 처분은 '타이밍'이 생명입니다. 초기 대응 단계에서의 작은 실수가 회복 불가능한 결과로 이어질 수 있습니다.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#0F4C81] to-[#1a1a1a] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-12">
            24시간 상담 가능 | 지금 전화주시면 바로 답변해 드립니다.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <div className="flex items-center justify-center gap-4 text-2xl font-bold">
              <Phone className="w-8 h-8 text-[#F5A623]" /> 02-1234-5678
            </div>
          </div>
        </div>
      </section>
