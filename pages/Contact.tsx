        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-start">
          ...
          <div className="space-y-6 md:y-8">
            ...
            <a href={`tel:${CONTACT.phone.replace(/-/g, '')}`} className="flex items-center gap-3 md:gap-6 p-4 md:p-8 bg-white rounded-xl shadow-md border border-gray-100 hover:border-[#F5A623] transition-all group overflow-hidden">
              ...
              <div className="flex-grow min-w-0">
                <p className="text-[9px] md:text-xs text-gray-400 font-bold uppercase tracking-widest mb-1">전화 상담</p>
                <p className="font-bold text-[15px] sm:text-xl md:text-2xl text-[#0F4C81] whitespace-nowrap overflow-visible">
                  {CONTACT.phone}
                </p>
              </div>
            ...
            <a 
              ...
              className="flex items-center gap-3 md:gap-6 p-4 md:p-8 bg-white rounded-xl shadow-md border border-gray-100 hover:border-[#FAE100] transition-all group cursor-pointer"
            >
              ...
              <div className="flex-grow">
                <p className="text-[9px] md:text-xs text-gray-400 font-bold uppercase tracking-widest mb-1">카카오톡 문의</p>
                <p className="font-bold text-base sm:text-xl md:text-2xl text-[#3C1E1E]">상담하기</p>
              </div>
              <ChevronRight className="text-gray-300 group-hover:text-[#FAE100] transition-colors shrink-0 w-4 h-4 md:w-6 md:h-6" />
            </a>

            <div className="p-6 md:p-8 bg-gray-50 rounded-xl border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3 mb-3 md:mb-4">
                <Clock className="text-[#0F4C81] w-4 h-4 md:w-5 md:h-5" />
                <h3 className="font-bold text-sm md:text-base">상담 가능 시간</h3>
              </div>
              <p className="text-gray-600 leading-relaxed break-keep text-[11px] md:text-base">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="relative">
              <div className="bg-gray-100 w-full h-56 md:h-80 rounded-xl overflow-hidden shadow-lg relative border-2 border-[#0F4C81]/10">
                <iframe 
                ...
                <div className="absolute inset-0 pointer-events-none flex flex-col items-center justify-center">
                  <div className="mb-14 flex flex-col items-center">
                    <div className="bg-[#0F4C81] text-white px-2 py-1 rounded-md text-[9px] md:text-xs font-bold shadow-2xl border border-white mb-1">
                      광성빌딩 605호 (행정 114)
                    </div>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 md:gap-4">
                <MapPin className="text-[#0F4C81] w-5 h-5 md:w-6 md:h-6 mt-1 shrink-0" />
                <div className="flex-grow">
              ...
              <div className="bg-[#0F4C81]/5 p-5 md:p-6 rounded-xl border border-[#0F4C81]/10">
                <h4 className="font-bold mb-1 md:mb-2 text-[#0F4C81] text-sm md:text-base flex items-center gap-2">
                ...
                <p className="text-[10px] text-gray-500 mt-1 break-keep">방문 전 연락 주시면 주차 자리를 미리 확인해 드립니다.</p>
              </div>
            </div>
          </div>
        </div>
